...
urlpatterns = [
    ...
    path('category/<str:name>/', views.PostListByCategoryView.as_view(), name='category_post'),
    
    re_path(r'^blog/tag/(?P<tag_slug>[-\w\u0600-\u06FF]+)/$', views.PostListByTagView.as_view(), name='posts_by_tag'),
]
